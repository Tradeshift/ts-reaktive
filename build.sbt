...
scalaVersion := "2.13.13" // just for the root
...
lazy val projectSettings = Seq(
  ...
  dependencyOverrides += "com.google.protobuf" % "protobuf-java" % "3.25.3",
  ...
  libraryDependencies ++= Seq(
    ...
    "org.apache.cassandra" % "cassandra-all" % "4.1.4" % "test" exclude("ch.qos.logback", "logback-classic"),
...
lazy val kamonSettings = Seq(
  libraryDependencies ++= {
    Seq(
      ...
      "org.aspectj" % "aspectjweaver" % "1.9.21.1",
